...
public class ValuuttaTest {
	...
	public void testGetTunnus() {
		assertEquals("EUR", valuutta.getTunnus(), "Valuutan tunnus v√§√§rin");
	}
	...
	public void testGetNimi() {
		assertEquals("Euroopan euro", valuutta.getNimi(), "Valuutan tunnus v√§√§rin");
	}
	...
	public void testGetVaihtokurssi() {
		assertEquals(1.0, valuutta.getVaihtokurssi(), DELTA, "Valuutan vaihtoarvo v√§√§rin");
	}
	...
	public void testSetTunnus3() {
		valuutta.setTunnus("PITK√Ñ");
		assertEquals("PIT", valuutta.getTunnus(), "Valuutan tunnus liian pitk√§.");
	}	
	...
	public void testSetNimi2() {
		valuutta = new Valuutta("TWD", 1.0, "Etel‰-Afrikan randin kansainv‰linen tunnus 12345678901234567890");
		assertEquals("Etel‰-Afrikan randin kansainv‰linen tunnus 1234567", valuutta.getNimi(), "Valuutan nimi virheellinen");
	}
	...
	public void testSetVaihtokurssi() {
		...
		assertEquals(1.01, valuutta.getVaihtokurssi(), DELTA, "Valuutan vaihtokurssin p√§ivitys v√§√§rin");
	}
	...
	public void testValuutta2() {
		...
		assertEquals("OKT", valuutta.getTunnus(), "Valuutan tunnus asetettu v√§√§rin");
		...
		assertEquals("OKT", valuutta.getTunnus(), "Valuutan tunnus liian pitk√§");
	}
